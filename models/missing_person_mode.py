...
class MissingPersonMode(GameMode):
    ...
    tags: ClassVar[List[str]] = ['photo', 'culture']
    icon: ClassVar[str] = 'fa-user-slash'
    ...
    def initialize(self, user_id: Optional[int] = None) -> Dict[str, Any]:
        ...
        raw_employees = self.game_manager.employee_data.get_all_employees()
        all_employees = self.eligible_employees(raw_employees)
